odoo.define('hr_copefrito_paie.timesheet', function (require) {
"use strict";
//alert("here");
...
var WeeklyTimesheetNew = form_common.FormWidget.extend(form_common.ReinitializeWidgetMixin, {
    events: {
    ...
    display_data: function() {
        var self = this;
        self.$el.html(QWeb.render("hr_copefrito_paie.WeeklyTimesheetNew", {widget: self}));
    ...
    sync: function() {
        ...
        //no convertion for float durations
...
core.form_custom_registry.add('weekly_timesheet_new', WeeklyTimesheetNew);
